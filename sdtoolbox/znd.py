...
def zndsolve(gas, gas1, U1,
             ...
             advanced_output=False, Method='LSODA'):
    """
    ...
    if advanced_output:
        ...
        output['max_thermicity_ZND'] = max(output['thermicity'])  # for Ng et al Chi parameter
        ...
        if n == b:
            ...
            print('You may have an eigenvalue detonation,'
